 defmodule Gringotts.Gateways.TrexleMock do
    ...
    def test_for_purchase_with_invalid_amount do
      ...
      headers: [{"Date", "Sat, 23 Dec 2017 18:16:33 GMT"},
      {"Content-Type", "application/json; charset=UTF-8"},
      {"Cache-Control", "no-cache"},
      {"X-Request-Id", "4ce2eea4-3ea9-4345-ac85-9bc45f22f5ac"},
      {"X-Runtime", "0.476058"}, {"Content-Length", "70"},
      {"X-Powered-By", "PleskLin"}, {"Connection", "close"}],
      request_url: "https://core.trexle.com/api/v1//charges", status_code: 400} 
    end

    def test_for_authorize_with_valid_card do 
      %HTTPoison.Response{body: "{\"response\":{\"token\":\"charge_8ab2b21a2f02495f5c36b34d129c8a0e836add32\",\"success\":true,\"captured\":false}}",
      headers: [{"Date", "Sat, 23 Dec 2017 18:33:31 GMT"},
      {"Content-Type", "application/json; charset=UTF-8"},
      {"ETag", "W/\"ec4f2df0607614f67286ac46eb994150\""},
      {"Cache-Control", "max-age=0, private, must-revalidate"},
      {"X-Request-Id", "51d28d13-81e5-41fd-b711-1b6531fdd3dd"},
      {"X-Runtime", "0.738395"}, {"Content-Length", "104"},
      {"X-Powered-By", "PleskLin"}],
      request_url: "https://core.trexle.com/api/v1//charges", status_code: 201}
    end
    ...
    def test_for_authorize_with_invalid_card do
      %HTTPoison.Response{body: "{\"error\":\"Payment failed\",\"detail\":\"Your card's expiration year is invalid.\"}",
      headers: [{"Date", "Sat, 23 Dec 2017 18:25:40 GMT"},
      {"Content-Type", "application/json; charset=UTF-8"},
      {"Cache-Control", "no-cache"},
      {"X-Request-Id", "239e7054-9500-4a87-bf3b-09456d550b6d"},
      {"X-Runtime", "0.466670"}, {"Content-Length", "77"},
      {"X-Powered-By", "PleskLin"}, {"Connection", "close"}],
      request_url: "https://core.trexle.com/api/v1//charges", status_code: 400} 
    end
    ...
    def test_for_authorize_with_invalid_amount do
      ...
      {"X-Runtime", "0.494636"}, {"Content-Length", "70"},
      {"X-Powered-By", "PleskLin"}, {"Connection", "close"}],
      request_url: "https://core.trexle.com/api/v1//charges", status_code: 400} 
    end
    ...
    def test_for_refund_with_valid_token do 
      ...
      {"X-Runtime", "1.097186"}, {"Content-Length", "198"},
      {"X-Powered-By", "PleskLin"}],
    ...
    def test_for_refund_with_invalid_token do
      %HTTPoison.Response{body: "{\"error\":\"Refund failed\",\"detail\":\"invalid token\"}",
      headers: [{"Date", "Sat, 23 Dec 2017 18:53:09 GMT"},
      {"Content-Type", "application/json; charset=UTF-8"},
      {"Cache-Control", "no-cache"},
      {"X-Request-Id", "276fd8f5-dc21-40be-8add-fa76aabbfc5b"},
      {"X-Runtime", "0.009374"}, {"Content-Length", "50"},
      {"X-Powered-By", "PleskLin"}, {"Connection", "close"}],
    ...
    def test_for_capture_with_valid_chargetoken do 
      %HTTPoison.Response{body: "{\"response\":{\"token\":\"charge_cb17a0c34e870a479dfa13bd873e7ce7e090ec9b\",\"success\":true,\"captured\":true,\"amount\":50,\"status_message\":\"Transaction approved\"}}",
      headers: [{"Date", "Sat, 23 Dec 2017 18:49:50 GMT"},
      {"Content-Type", "application/json; charset=UTF-8"},
      {"ETag", "W/\"26f05a32c0d0a27b180bbe777488fd5f\""},
      {"Cache-Control", "max-age=0, private, must-revalidate"},
      {"X-Request-Id", "97ca2db6-fd4f-4a5b-ae45-01fae9c13668"},
      {"X-Runtime", "1.092051"}, {"Content-Length", "155"},
      {"X-Powered-By", "PleskLin"}],
    ...
    def test_for_capture_with_invalid_chargetoken do 
      %HTTPoison.Response{body: "{\"error\":\"Capture failed\",\"detail\":\"invalid token\"}",
      headers: [{"Date", "Sat, 23 Dec 2017 18:47:18 GMT"},
      {"Content-Type", "application/json; charset=UTF-8"},
      {"Cache-Control", "no-cache"},
      {"X-Request-Id", "b46ecb8d-7df8-4c5f-b87f-c53fae364e79"},
      {"X-Runtime", "0.010255"}, {"Content-Length", "51"},
      {"X-Powered-By", "PleskLin"}, {"Connection", "close"}],

defmodule Gringotts.Gateways.MercadopagoTest do
  ...
  alias Gringotts.Gateways.MercadopagoMock, as: MockResponse
  ...
  describe "purchase" do
    test "successful response with right params" do
      with_mock HTTPoison,
        ...
        assert {:ok, _response} = Merc.purchase(@amount, @card, @opts)
      end
    end
    ...
    test "with bad card" do
      with_mock HTTPoison,
        ...
        assert {:error, _response} = Merc.purchase(@amount, @bad_card, @opts)
      end
    end
  end
  ...
  describe "authorize" do
    test "successful response with right params" do
      with_mock HTTPoison,
        ...
        assert {:ok, _response} = Merc.authorize(@amount, @card, @opts)
      end
    end
  ...
  describe "capture" do
    test "successful response with right params" do
      with_mock HTTPoison,
        ...
        assert {:ok, _response} = Merc.capture(@capture_id, @amount, @opts)
      end
    end

    test "with bad transaction id" do
      with_mock HTTPoison,
        request: fn _method, _url, _body, _headers, _options -> MockResponse.bad_id_capture() end do
        assert {:error, _response} = Merc.capture(@capture_invalid_id, @amount, @opts)
      end
    end
  end
  ...
  describe "refund" do
    test "successful response with right params" do
      with_mock HTTPoison,
        ...
        assert {:ok, _response} = Merc.refund(@amount, @refund_id, @opts_refund)
      end
    end

    test "bad payment params" do
      with_mock HTTPoison,
        request: fn _method, _url, _body, _headers, _options -> MockResponse.bad_card_refund() end do
        assert {:error, _response} = Merc.refund(@amount, @refund_id, @opts_refund_bad_payment)
      end
    end
    ...
    test "debit less than refund amount" do
      with_mock HTTPoison,
        ...
        assert {:error, _response} = Merc.refund(@amount, @refund_id, @opts_refund)
      end
    end
  end
  ...
  describe "void" do
    test "successful response with right params" do
      with_mock HTTPoison,
        request: fn _method, _url, _body, _headers, _options -> MockResponse.successful_void() end do
        assert {:ok, _response} = Merc.void(@void_id, @opts)
      end
    end
    ...
    test "with bad transaction id" do
      with_mock HTTPoison,
        ...
        assert {:error, _response} = Merc.void(@void_invalid_id, @opts)
      end
    end
  end
  ...
  test "network error type non existent domain" do
    with_mock HTTPoison,
      ...
      assert {:error, response} = Merc.purchase(@amount, @card, @opts)
